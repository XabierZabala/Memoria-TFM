...
En Cassandra, gracias a un conjunto de mecanismos peer-to-peer, cada nodo es capaz de obtener dicha información de forma local sin depender de un nodo maestro, obteniendo un clúster totalmente homogéneo, en cuanto a funcionamiento se refiere.\\ 
...
Cada mensaje Gossip tiene una versión asociada a él, gracias al cual el nodo que recibe dicho mensaje puede comparar con la información que tiene de antemano y sobrescribir su conocimiento en caso de ser necesario.\\
...
\textbf{Failure Detector}\cite{chandra1996unreliable}
...
Cassandra utiliza accrual detection mechanism para calcular un umbral por nodo que tenga en cuenta el rendimiento de red, carga de trabajo, u otras condiciones. // uso: redirigir las consultas hacia un nodo que no esta caido
